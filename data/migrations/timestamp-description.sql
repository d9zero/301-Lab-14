psql -d cityexplorer -f schema.sql
\l
\q
pgstart
\l
...
SELECT lab14 CREATE Table authors
\l
DELETE lab14
\l
\l
...
-- TRANSFER INFORMATION FROM THE FORMER TABLE TO THE NEW TABLE
SELECT COUNT(*) FROM books;
...
SHOW TABLES
\dt
INSERT INTO books FROM seed.sql
\dt
INSERT INTO books
SELECT * FROM seed.sql
;
\dt
INSERT INTO books SELECT * FROM seed.sql;
...
\dt
SELECT * FROM /documents/projects/codefellows/301/week3/301-Lab-14/seed.sql
INSERT INTO books
\dt
SHOW
\dt
...
\dt
SELECT * FROM books;
DROP DATABASE IF EXISTS lab14_normal
CREATE DATABASE lab14_normal WITH TEMPLATE lab14;
DROP DATABASE IF EXISTS lab14_normal;
\l
CREATE DATABASE lab14_normal WITH TEMPLATE lab14;
...
\d books
\s
\s ./data/migrations/timestamp-description.sql
